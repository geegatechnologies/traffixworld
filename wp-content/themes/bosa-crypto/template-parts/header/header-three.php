<header id="masthead" class="site-header header-three">
	<div class="top-header">
		<?php if( !get_theme_mod( 'bosa_crypto_disable_top_header_section', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'bosa_crypto_disable_header_social_links', false ) && bosa_crypto_has_social() ) || has_nav_menu( 'menu-3') ){ ?>
		...
		<?php if( !get_theme_mod( 'bosa_crypto_disable_mobile_top_header', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'bosa_crypto_disable_header_social_links', false ) && bosa_crypto_has_social() ) || has_nav_menu( 'menu-3') || !get_theme_mod( 'bosa_crypto_disable_search_icon', false ) || is_active_sidebar( 'menu-sidebar' ) ){ ?>
