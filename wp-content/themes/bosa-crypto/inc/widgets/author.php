<?php
/**
* Bosa Crypto Author Widget
*
* @since Bosa Crypto 1.0.0
*/
if( ! class_exists( 'Bosa_Crypto_Author_Widget' ) ) :
    
    class Bosa_Crypto_Author_Widget extends Bosa_Crypto_Base_Widget {
        ...
        public function __construct() {
            ...
            $widget_ops = array(
                'description' => esc_html__( 'Display your Profile Page with Social Media Links.', 'bosa-crypto' ), 
                'customize_selective_refresh' => true
            );
            
            parent::__construct(
                'bosa_crypto_author_widget', 
                esc_html__( 'Bosa Crypto Author', 'bosa-crypto' ),
                $widget_ops
            );

            $this->fields = array(
                'title' => array(
                    'label'   => esc_html__( 'Widget Title', 'bosa-crypto' ),
                    'type'    => 'text',
                    'default' => esc_html__( 'About Author', 'bosa-crypto' )
                ),
                'page_id' => array(
                    'label' => esc_html__( 'Select Page', 'bosa-crypto' ),
                    'type'  => 'dropdown-pages',
                ),
                'full-square-thumb' => array(
                    'label'   => esc_html__( 'Enable Full Size Feature Image', 'bosa-crypto' ),
                    'type'    => 'checkbox',
                    'default' => false,
                ),
                'page_title' => array(
                    'label'   => esc_html__( 'Enable Page Title', 'bosa-crypto' ),
                    'type'    => 'checkbox',
                    'default' => true,
                ),
                'excerpt_count' => array(
                    'label'   => esc_html__( 'Excerpt Words count to show.', 'bosa-crypto' ),
                    'type'    => 'number',
                    'default' => 20,
                ),
                'sub_title' => array(
                    'label'   => esc_html__( 'Sub Title', 'bosa-crypto' ),
                    'type'    => 'text',
                    'default' => esc_html__( 'Lifestyle Blogger','bosa-crypto' )
                ),
                ...
                'social_title' => array(
                    'label'   => esc_html__( '= Social Icons =', 'bosa-crypto' ),
                    'type'    => 'description',
                ),
                 'social_desc' => array(
                    'label'   => esc_html__( 'Input Icon name. For Example:- fab fa-facebook For more icons https://fontawesome.com/icons?d=gallery&m=free', 'bosa-crypto' ),
                    'type'    => 'description',
                ),
                'social_menu_icon_1' => array(
                    'label' => esc_html__( 'Social Icon 1', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_1' => array(
                    'label' => esc_html__( 'Social Icon Link 1', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_2' => array(
                    'label' => esc_html__( 'Social Icon 2', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_2' => array(
                    'label' => esc_html__( 'Social Icon Link 2', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_3' => array(
                    'label' => esc_html__( 'Social Icon 3', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_3' => array(
                    'label' => esc_html__( 'Social Icon Link 3', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_4' => array(
                    'label' => esc_html__( 'Social Icon 4', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_4' => array(
                    'label' => esc_html__( 'Social Icon Link 4', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_5' => array(
                    'label' => esc_html__( 'Social Icon 5', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_5' => array(
                    'label' => esc_html__( 'Social Icon Link 5', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_6' => array(
                    'label' => esc_html__( 'Social Icon 6', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_6' => array(
                    'label' => esc_html__( 'Social Icon Link 6', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_7' => array(
                    'label' => esc_html__( 'Social Icon 7', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_7' => array(
                    'label' => esc_html__( 'Social Icon Link 7', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_8' => array(
                    'label' => esc_html__( 'Social Icon 8', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_8' => array(
                    'label' => esc_html__( 'Social Icon Link 8', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_9' => array(
                    'label' => esc_html__( 'Social Icon 9', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_9' => array(
                    'label' => esc_html__( 'Social Icon Link 9', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
                'social_menu_icon_10' => array(
                    'label' => esc_html__( 'Social Icon 10', 'bosa-crypto' ),
                    'type'  => 'text',
                ), 
                'social_menu_link_10' => array(
                    'label' => esc_html__( 'Social Icon Link 10', 'bosa-crypto' ),
                    'type'  => 'text',
                ),
        ...
        public function widget( $args, $instance ) {
            ...
            <section class="author-widget class-<?php echo esc_attr( $unique_id ); ?> <?php echo esc_attr( $author_thumbnail_class ); ?>">
                ...
                if( !isset( $instance[ 'title' ] ) || empty( $instance[ 'title' ] ) ){
                    $instance[ 'title' ] = esc_html__( 'About Author', 'bosa-crypto' );
                }
                    ...
                    <div class="profile">
                        ...
                        <div class="text-content">
                            ...
                            <?php
                                ...
                                bosa_crypto_excerpt( $excerpt_count , true );
                            ?>
                        </div>
