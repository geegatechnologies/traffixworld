...
function bosa_crypto_modify_default_settings( $wp_customize ){

	$wp_customize->get_setting( 'blogname' )->transport = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport = 'postMessage';

}
add_action( 'customize_register', 'bosa_crypto_modify_default_settings' );

if( !function_exists( 'bosa_crypto_hex2rgba' ) ):
/**
* Convert hexdec color string to rgb(a) string
*/
function bosa_crypto_hex2rgba($color, $opacity = false) {
...
function bosa_crypto_default_styles(){
	...
	# Site Title
	#Site Title Height
	$logo_width = get_theme_mod( 'bosa_crypto_logo_width', 270 );
	$css .= '
	...
	$site_title_color = get_theme_mod( 'bosa_crypto_site_title_color', '#030303' );
	$site_tagline_color = get_theme_mod( 'bosa_crypto_site_tagline_color', '#767676' );
	$css .= '
		/* Site Title */
	...
	# Colors
	$site_body_text_color = get_theme_mod( 'bosa_crypto_site_body_text_color', '#333333' );
	$site_heading_text_color = get_theme_mod( 'bosa_crypto_site_heading_text_color', '#030303' );
	$header_textcolor = get_theme_mod( 'bosa_crypto_header_textcolor', '#101010' );
	$site_primary_color = get_theme_mod( 'bosa_crypto_site_primary_color', '#00D094' );
	$site_hover_color = get_theme_mod( 'bosa_crypto_site_hover_color', '#0A4FD5' );
	$site_general_link_color = get_theme_mod( 'bosa_crypto_site_general_link_color', '#a6a6a6' );
	$css .= '
	...
	# Overlay Opacity
	$feature_posts_overlay_opacity = get_theme_mod( 'bosa_crypto_feature_posts_overlay_opacity', 4 );
	$css .= '
		/* Feature Posts*/
	...
	$top_header_background_color = get_theme_mod( 'bosa_crypto_top_header_background_color', '' );
	$top_header_text_color = get_theme_mod( 'bosa_crypto_top_header_text_color', '#333333' );
	$top_header_text_link_hover_color = get_theme_mod( 'bosa_crypto_top_header_text_link_hover_color', '#0A4FD5' );
	$sub_menu_link_hover_color = get_theme_mod( 'bosa_crypto_sub_menu_link_hover_color', '#0A4FD5' );
	$css .= '
	...
	$header_icon_color = get_theme_mod( 'bosa_crypto_header_icon_color', '#B7B7B7' );
	$css .= '
	...
	$mid_header_background_color = get_theme_mod( 'bosa_crypto_mid_header_background_color', '' );
	$mid_header_text_link_hover_color = get_theme_mod( 'bosa_crypto_mid_header_text_link_hover_color', '#0A4FD5' );
	$css .= '
		.mid-header .overlay {
	...
	$bottom_header_background_color = get_theme_mod( 'bosa_crypto_bottom_header_background_color', '' );
	$bottom_header_text_color = get_theme_mod( 'bosa_crypto_bottom_header_text_color', '#333333' );
	$bottom_header_text_link_hover_color = get_theme_mod( 'bosa_crypto_bottom_header_text_link_hover_color', '#0A4FD5' );
	$css .= '
	...
	$css .= '
		...
		.header-fourteen .bottom-contact {
			border-color: '. esc_attr( bosa_crypto_hex2rgba( $bottom_header_text_color, 0.1 ) ).';
		}
	...
	$transparent_header_top_background_color = get_theme_mod( 'bosa_crypto_transparent_header_top_background_color', '' );
	$transparent_header_bottom_background_color = get_theme_mod( 'bosa_crypto_transparent_header_bottom_background_color', '' );
	$transparent_header_top_header_color = get_theme_mod( 'bosa_crypto_transparent_header_top_header_color', '#ffffff' );
	$top_hover_color_transparent_header = get_theme_mod( 'bosa_crypto_top_hover_color_transparent_header', '#0A4FD5' );
	$site_title_color_transparent_header = get_theme_mod( 'bosa_crypto_site_title_color_transparent_header', '#ffffff' );
	$site_tagline_color_transparent_header = get_theme_mod( 'bosa_crypto_site_tagline_color_transparent_header', '#e6e6e6' );
	$content_color_transparent_header = get_theme_mod( 'bosa_crypto_content_color_transparent_header', '#ffffff' );
	$content_hover_color_transparent_header = get_theme_mod( 'bosa_crypto_content_hover_color_transparent_header', '#0A4FD5' );

	if( is_front_page() && !is_home() && !defined('ELEMENTOR_VERSION') ){
		#Header two static front page fix 
		$site_title_color_transparent_header = get_theme_mod( 'bosa_crypto_site_title_color', '#030303' );
		$site_tagline_color_transparent_header = get_theme_mod( 'bosa_crypto_site_tagline_color', '#767676' );

		$transparent_header_top_background_color = get_theme_mod( 'bosa_crypto_top_header_background_color', '' );
		$transparent_header_top_header_color = get_theme_mod( 'bosa_crypto_top_header_text_color', '#333333' );
		$top_hover_color_transparent_header = get_theme_mod( 'bosa_crypto_top_header_text_link_hover_color', '#0A4FD5' );

		$transparent_header_bottom_background_color = get_theme_mod( 'bosa_crypto_bottom_header_background_color', '' );
		$content_color_transparent_header = get_theme_mod( 'bosa_crypto_bottom_header_text_color', '#333333' );
		$content_hover_color_transparent_header = get_theme_mod( 'bosa_crypto_bottom_header_text_link_hover_color', '#0A4FD5' );
	...
	';
	if ( !get_theme_mod( 'bosa_crypto_disable_fixed_header', true ) ){
		$bg_color_fixed_header	 		 = get_theme_mod( 'bosa_crypto_bg_color_fixed_header', '' );
		$site_title_color_fixed_header	 = get_theme_mod( 'bosa_crypto_site_title_color_fixed_header', '' );
		$site_tagline_color_fixed_header = get_theme_mod( 'bosa_crypto_site_tagline_color_fixed_header', '' );
		$text_color_fixed_header 		 = get_theme_mod( 'bosa_crypto_text_color_fixed_header', '' );
		$text_hover_color_fixed_header 	 = get_theme_mod( 'bosa_crypto_text_hover_color_fixed_header', '' );
		...
		';
		if( !get_theme_mod( 'bosa_crypto_disable_header_button', false ) ){
			$fixed_header_button_background_color 	 = get_theme_mod( 'bosa_crypto_fixed_header_button_background_color', '' );
			$fixed_header_button_border_color 		 = get_theme_mod( 'bosa_crypto_fixed_header_button_border_color', '' );
			$fixed_header_button_text_color 		 = get_theme_mod( 'bosa_crypto_fixed_header_button_text_color', '' );
			$css .= '
				/* Header Button */
	...
	if( !get_theme_mod( 'bosa_crypto_disable_header_button', false ) ){
		if( get_theme_mod( 'bosa_crypto_header_layout', 'header_one' ) == 'header_one' || get_theme_mod( 'bosa_crypto_header_layout', 'header_one' ) == 'header_fourteen' ){
			...
			$header_buttons = get_theme_mod( 'bosa_crypto_header_button_repeater', $header_btn_defaults );
	...
	if( !get_theme_mod( 'bosa_crypto_disable_header_button', false ) ){
		if( get_theme_mod( 'bosa_crypto_header_layout', 'header_one' ) == 'header_two' ){
			...
			$transparent_header_buttons = get_theme_mod( 'bosa_crypto_transparent_header_button_repeater', $transparent_header_btn_defaults );
			if( !empty( $transparent_header_buttons ) && is_array( $transparent_header_buttons ) ){
		    	...
		    	foreach( $transparent_header_buttons as $value ){
					...
					if( ( !get_theme_mod( 'bosa_crypto_disable_transparent_header_page', true ) && is_page() ) || ( !get_theme_mod( 'bosa_crypto_disable_transparent_header_post', true ) && is_single() ) || is_front_page() ){
	...
	# Fixed Header
	if( get_theme_mod( 'bosa_crypto_disable_fixed_header_logo', false ) ){
		$css .= '
	...
	$the_custom_logo_url = bosa_crypto_get_custom_logo_url();
	if( $the_custom_logo_url == ''  && ( get_theme_mod( 'bosa_crypto_header_layout', 'header_one' ) !== 'header_two' || ( !is_front_page() && ( get_theme_mod( 'bosa_crypto_disable_transparent_header_post', true ) && !is_single() ) && ( get_theme_mod( 'bosa_crypto_disable_transparent_header_page', true ) && !is_page() ) ) || empty( get_theme_mod( 'bosa_crypto_header_separate_logo', '' ) ) ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_fixed_header_site_title', false ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_fixed_header_site_tagline', false ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_fixed_header', true ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_top_header_border', false ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_mid_header_border', false ) ){
		$css .= '
			@media screen and (min-width: 992px){
				.mid-header {
					border-bottom: none;
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_top_header_border', false ) ){
		$css .= '
			@media screen and (max-width: 991px){
				.top-header {
					border-bottom: none;
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_mid_header_border', false ) ){
		$css .= '
			@media screen and (max-width: 991px){
				.mid-header,
				.bottom-header,
	...
	$fixed_header_logo_width = get_theme_mod( 'bosa_crypto_fixed_header_logo_width', 270 );
	$css .= '
	...
	# Header Image / Slider
	#Header Image Height
	$header_image_height = get_theme_mod( 'bosa_crypto_header_image_height', 100 );
	$css .= '
	...
	# Header Image Sizes
	#Cover Size
	if( get_theme_mod( 'bosa_crypto_header_image_size', 'cover' ) == 'cover' ){
		$css .= '
			.header-slide-item {
	...
	#Repeat Size
	elseif( get_theme_mod( 'bosa_crypto_header_image_size', 'cover' ) == 'pattern' ){
		$css .= '
			.header-slide-item {
				background-position: center center;
	...
	#Fit Size
	elseif( get_theme_mod( 'bosa_crypto_header_image_size', 'cover' ) == 'norepeat' ){
		$css .= '
			.header-slide-item {
				background-position: center center;
				background-repeat: no-repeat;
	...
	#Parallax Scrolling
	if( !get_theme_mod( 'bosa_crypto_disable_parallax_scrolling', true ) ){
		$css .= '
		.header-slide-item {
				background-position: center center;
	...
	$transparent_header_banner_post_height = get_theme_mod( 'bosa_crypto_transparent_header_banner_post_height', 400 );
	$css .= '
	...
	#Cover Size
	if( get_theme_mod( 'bosa_crypto_transparent_header_banner_post_size', 'cover' ) == 'cover' ){
		$css .= '
			.overlay-post .inner-banner-content {
				background-position: center center;
				background-repeat: no-repeat;
	...
	#Repeat Size
	elseif( get_theme_mod( 'bosa_crypto_transparent_header_banner_post_size', 'cover' ) == 'pattern' ){
		$css .= '
			.overlay-post .inner-banner-content {
				background-position: center center;
				background-repeat: repeat;
	...
	#Fit Size
	elseif( get_theme_mod( 'bosa_crypto_transparent_header_banner_post_size', 'cover' ) == 'norepeat' ){
		$css .= '
			.overlay-post .inner-banner-content {
				background-position: center center;
				background-repeat: no-repeat;
	...
	$transparent_header_banner_post_opacity = get_theme_mod( 'bosa_crypto_transparent_header_banner_post_opacity', 4 );
	$css .= '
	...
	$transparent_header_banner_page_height = get_theme_mod( 'bosa_crypto_transparent_header_banner_page_height', 400 );
	$css .= '
		@media only screen and (min-width: 768px) {
	...
	#Cover Size
	if( get_theme_mod( 'bosa_crypto_transparent_header_banner_page_size', 'cover' ) == 'cover' ){
		$css .= '
			.overlay-page .inner-banner-content {
				background-position: center center;
				background-repeat: no-repeat;
	...
	#Repeat Size
	elseif( get_theme_mod( 'bosa_crypto_transparent_header_banner_page_size', 'cover' ) == 'pattern' ){
		$css .= '
			.overlay-page .inner-banner-content {
				background-position: center center;
				background-repeat: repeat;
	...
	#Fit Size
	elseif( get_theme_mod( 'bosa_crypto_transparent_header_banner_page_size', 'cover' ) == 'norepeat' ){
		$css .= '
			.overlay-page .inner-banner-content {
				background-position: center center;
				background-repeat: no-repeat;
	...
	$transparent_header_banner_page_opacity = get_theme_mod( 'bosa_crypto_transparent_header_banner_page_opacity', 4 );
	$css .= '
	...
	# Main Slider / Image
	#Height
	$main_slider_height = get_theme_mod( 'bosa_crypto_main_slider_height', 550 );
	$css .= '
		@media only screen and (min-width: 768px) {
			.banner-img {
	...
	if ( get_theme_mod( 'bosa_crypto_main_slider_controls', 'slider' ) == 'slider' ){
		#Blog Slider Color 
		$background_color_main_slider = get_theme_mod( 'bosa_crypto_background_color_main_slider', '');
		$slider_post_title_color 	= get_theme_mod( 'bosa_crypto_slider_post_title_color', '#ffffff' );
		$slider_post_category_color = get_theme_mod( 'bosa_crypto_slider_post_category_color', '#ebebeb' );
		$slider_post_meta_color 	= get_theme_mod( 'bosa_crypto_slider_post_meta_color', '#ebebeb' );
		$slider_post_meta_icon_color = get_theme_mod( 'bosa_crypto_slider_post_meta_icon_color', '#00D094' );
		$slider_post_text_color 	= get_theme_mod( 'bosa_crypto_slider_post_text_color', '#ffffff' );
		$separate_hover_color_for_main_slider = get_theme_mod( 'bosa_crypto_separate_hover_color_for_main_slider', '#0A4FD5' );
		$css .= '
		...
		if( !get_theme_mod( 'bosa_crypto_hide_slider_button', false ) ){
			...
			$slider_button = get_theme_mod( 'bosa_crypto_main_slider_button_repeater', $slider_btn_defaults );
		...
		#Image Sizes Slider
		#Cover Size
		if( get_theme_mod( 'bosa_crypto_main_slider_image_size', 'cover' ) == 'cover' ){
			$css .= '
		...
		#Repeat Size
		elseif( get_theme_mod( 'bosa_crypto_main_slider_image_size', 'cover' ) == 'pattern' ){
			$css .= '
				.main-slider .banner-img {
					background-position: center center;
					background-repeat: repeat;
		...
		#Fit Size
		elseif( get_theme_mod( 'bosa_crypto_main_slider_image_size', 'cover' ) == 'norepeat' ){
			$css .= '
				.main-slider .banner-img {
					background-position: center center;
					background-repeat: no-repeat;
	...
	elseif( get_theme_mod( 'bosa_crypto_main_slider_controls', 'slider' ) == 'banner' ){
		#Blog Banner Color 
		$background_color_main_banner = get_theme_mod( 'bosa_crypto_background_color_main_banner', '');
		$banner_title_color 	= get_theme_mod( 'bosa_crypto_banner_title_color', '#ffffff' );
		$banner_subtitle_color 	= get_theme_mod( 'bosa_crypto_banner_subtitle_color', '#ffffff' );
		$css .= '
		...
		# Banner Button
		if( !get_theme_mod( 'bosa_crypto_disable_banner_buttons', false ) ){
			...
			$banner_buttons = get_theme_mod( 'bosa_crypto_main_banner_buttons_repeater', $banner_btn_defaults );
		...
		#Image Sizes Banner
		#Cover Size
		if( get_theme_mod( 'bosa_crypto_main_banner_image_size', 'cover' ) == 'cover' ){
			$css .= '
				.banner-img {
					background-position: center center;
					background-repeat: no-repeat;
		...
		#Repeat Size
		elseif( get_theme_mod( 'bosa_crypto_main_banner_image_size', 'cover' ) == 'pattern' ){
			$css .= '
				.banner-img {
					background-position: center center;
					background-repeat: repeat;
		...
		#Fit Size
		elseif( get_theme_mod( 'bosa_crypto_main_banner_image_size', 'cover' ) == 'norepeat' ){
			$css .= '
				.banner-img {
					background-position: center center;
					background-repeat: no-repeat;
	...
	# Footer Image Sizes
	#Cover Size
	if( get_theme_mod( 'bosa_crypto_footer_image_size', 'cover' ) == 'cover' ){
		$css .= '
	...
	#Repeat Size
	elseif( get_theme_mod( 'bosa_crypto_footer_image_size', 'cover' ) == 'pattern' ){
		$css .= '
			.site-footer.has-footer-bg .site-footer-inner {
				background-position: center center;
				background-repeat: repeat;
	...
	#Fit Size
	elseif( get_theme_mod( 'bosa_crypto_footer_image_size', 'cover' ) == 'norepeat' ){
		$css .= '
			.site-footer.has-footer-bg .site-footer-inner {
				background-position: center center;
				background-repeat: no-repeat;
	...
	if( get_theme_mod( 'bosa_crypto_disable_footer_widget_title_border', false ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_footer_widget_list_item_border', false ) ){
		$css .= '
	...
	$footer_widget_area_top_padding = get_theme_mod( 'bosa_crypto_footer_widget_area_top_padding', 0 );
	$footer_widget_area_bottom_padding = get_theme_mod( 'bosa_crypto_footer_widget_area_bottom_padding', 50 );
	$css .= '
		.footer-widget-wrap {
	...
	# Top Footer Color
	$top_footer_background_color = get_theme_mod( 'bosa_crypto_top_footer_background_color', '' );
	$top_footer_widget_title_color = get_theme_mod( 'bosa_crypto_top_footer_widget_title_color', '#030303' );
	$top_footer_widget_link_color = get_theme_mod( 'bosa_crypto_top_footer_widget_link_color', '#656565' );
	$top_footer_widget_content_color = get_theme_mod( 'bosa_crypto_top_footer_widget_content_color', '#656565' );
	$top_footer_widget_link_hover_color = get_theme_mod( 'bosa_crypto_top_footer_widget_link_hover_color', '#0A4FD5' );
	$css .= '
		.top-footer {
	...
	$css .= '
		...
		.widget ul li,
		.latest-posts-widget .post {
			border-bottom-color: '. esc_attr( bosa_crypto_hex2rgba( $top_footer_widget_link_color, 0.2 ) ).';
		}
	...
	$bottom_footer_area_top_padding = get_theme_mod( 'bosa_crypto_bottom_footer_area_top_padding', 30 );
	$bottom_footer_area_bottom_padding = get_theme_mod( 'bosa_crypto_bottom_footer_area_bottom_padding', 30 );
	$css .= '
		.bottom-footer {
	...
	# Bottom Footer Color
	$bottom_footer_background_color = get_theme_mod( 'bosa_crypto_bottom_footer_background_color', '' );
	$bottom_footer_text_color = get_theme_mod( 'bosa_crypto_bottom_footer_text_color', '#656565' );
	$bottom_footer_text_link_color = get_theme_mod( 'bosa_crypto_bottom_footer_text_link_color', '#383838' );
	$bottom_footer_text_link_hover_color = get_theme_mod( 'bosa_crypto_bottom_footer_text_link_hover_color', '#0A4FD5' );
	$css .= '
		.bottom-footer {
	...
	$css .= '
		.site-footer .social-profile ul li a {
			background-color: '. esc_attr( bosa_crypto_hex2rgba( $bottom_footer_text_link_color, 0.1 ) ).';
		}
	';
	...
	# Social Media Size
	$social_icons_size = get_theme_mod( 'bosa_crypto_social_icons_size', 15 );
	$css .= '
		.site-footer .social-profile ul li a {
	...
	#Parallax Scrolling
	if( !get_theme_mod( 'bosa_crypto_disable_footer_parallax_scrolling', true ) ){
		$css .= '
	...
	#Cover Size
	if( get_theme_mod( 'bosa_crypto_feature_posts_image_size', 'cover' ) == 'cover' ){
		$css .= '
	...
	#Repeat Size
	elseif( get_theme_mod( 'bosa_crypto_feature_posts_image_size', 'cover' ) == 'pattern' ){
		$css .= '
			.feature-posts-content-wrap .feature-posts-image {
				background-position: center center;
				background-repeat: repeat;
	...
	#Fit Size
	elseif( get_theme_mod( 'bosa_crypto_feature_posts_image_size', 'cover' ) == 'norepeat' ){
		$css .= '
			.feature-posts-content-wrap .feature-posts-image {
				background-position: center center;
				background-repeat: no-repeat;
	...
	$feature_posts_radius = get_theme_mod( 'bosa_crypto_feature_posts_radius', 0 );
	$css .= '
		.feature-posts-content-wrap .feature-posts-image {
	...
	if( get_theme_mod( 'bosa_crypto_feature_posts_title_alignment', 'align-bottom' ) == 'align-bottom' ){
		$css .= '
		...
		';
	}elseif( get_theme_mod( 'bosa_crypto_feature_posts_title_alignment', 'align-bottom' ) == 'align-top' ) {
		$css .= '
			.feature-posts-layout-one .feature-posts-image {
		...
		';
	}elseif( get_theme_mod( 'bosa_crypto_feature_posts_title_alignment', 'align-bottom' ) == 'align-center' ) {
		$css .= '
			.feature-posts-layout-one .feature-posts-image {
	...
	$preloader_custom_image_width = get_theme_mod( 'bosa_crypto_preloader_custom_image_width', 40 );
	$css .= '
		.preloader-content {
	...
	#Global Layouts
	if( get_theme_mod( 'bosa_crypto_site_layout', 'default' ) == 'box' || get_theme_mod( 'bosa_crypto_site_layout', 'default' ) == 'frame' ){
		$box_frame_background_color = get_theme_mod( 'bosa_crypto_box_frame_background_color', '' );
		$css .= '
			/* Box and Frame */
		...
		';
		if( get_theme_mod( 'bosa_crypto_box_frame_image_size', 'cover' ) == 'cover' ){
			$css .= '
				.site-layout-box,
				.site-layout-frame {
					background-position: center center;
		...
		elseif( get_theme_mod( 'bosa_crypto_box_frame_image_size', 'cover' ) == 'pattern' ){
			$css .= '
				.site-layout-box,
				.site-layout-frame {
					background-position: center center;
		...
		elseif( get_theme_mod( 'bosa_crypto_box_frame_image_size', 'cover' ) == 'norepeat' ){
			$css .= '
				.site-layout-box,
				.site-layout-frame {
					background-position: center center;
	...
	if( get_theme_mod( 'bosa_crypto_disable_site_layout_shadow', false ) ){
		$css .= '
    ...
    #Blog Page
    $blog_post_title_color = get_theme_mod( 'bosa_crypto_blog_post_title_color', '#101010' );
    $blog_post_category_color = get_theme_mod( 'bosa_crypto_blog_post_category_color', '#00D094' );
    $blog_post_meta_color = get_theme_mod( 'bosa_crypto_blog_post_meta_color', '#7a7a7a' );
    $blog_post_meta_icon_color = get_theme_mod( 'bosa_crypto_blog_post_meta_icon_color', '#00D094' );
    $blog_post_text_color = get_theme_mod( 'bosa_crypto_blog_post_text_color', '#333333' );
    $blog_post_hover_color = get_theme_mod( 'bosa_crypto_blog_post_hover_color', '#0A4FD5' );
    $latest_posts_radius = get_theme_mod( 'bosa_crypto_latest_posts_radius', 0 );
    $css .= '
    ...
    # Post Button
	if( !get_theme_mod( 'bosa_crypto_hide_post_button', true ) ){
		...
		$post_button = get_theme_mod( 'bosa_crypto_blog_page_button_repeater', $post_btn_defaults );
	...
	# Blog Homepage
	# Feature Posts
	$featured_post_title_color = get_theme_mod( 'bosa_crypto_featured_post_title_color', '#FFFFFF' );
	$featured_post_category_bgcolor = get_theme_mod( 'bosa_crypto_featured_post_category_bgcolor', '#00D094' );
    $featured_post_category_color = get_theme_mod( 'bosa_crypto_featured_post_category_color', '#FFFFFF' );
    $featured_post_meta_color = get_theme_mod( 'bosa_crypto_featured_post_meta_color', '#FFFFFF' );
    $featured_post_meta_icon_color = get_theme_mod( 'bosa_crypto_featured_post_meta_icon_color', '#00D094' );
    $featured_post_hover_color = get_theme_mod( 'bosa_crypto_featured_post_hover_color', '#0A4FD5' );
    $css .= '
	...
	$feature_posts_height = get_theme_mod( 'bosa_crypto_feature_posts_height', 250 );
	$css .= '
		.feature-posts-layout-one .feature-posts-image {
	...
	# Feature Posts
	if(  get_theme_mod( 'bosa_crypto_disable_feature_posts_title', false ) || get_theme_mod( 'bosa_crypto_disable_feature_title_divider', false ) ){
		$css .= '
			.feature-posts-layout-one .feature-posts-content .feature-posts-title a:after {
    			display: none;
			}
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_social_icons_footer', false ) ){
		$css .= '
			@media screen and (max-width: 991px){
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_main_slider', false ) ){
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_feature_posts', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_latest_posts', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.section-post-area {
	    			display: none;
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_highlight_posts', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	$highlight_post_title_color = get_theme_mod( 'bosa_crypto_highlight_post_title_color', '#030303' );
    $highlight_post_category_bgcolor = get_theme_mod( 'bosa_crypto_highlight_post_category_bgcolor', '#00D094' );
    $highlight_post_category_color = get_theme_mod( 'bosa_crypto_highlight_post_category_color', '#FFFFFF' );
    $highlight_post_meta_color = get_theme_mod( 'bosa_crypto_highlight_post_meta_color', '#7a7a7a' );
    $highlight_post_meta_icon_color = get_theme_mod( 'bosa_crypto_highlight_post_meta_icon_color', '#00D094' );
    $highlight_post_hover_color = get_theme_mod( 'bosa_crypto_highlight_post_hover_color', '#0A4FD5' );
    $css .= '
    	...
    	.highlight-layout-two .highlight-post-slider .post .cat-links a {
    		border-bottom-color: '. esc_attr( bosa_crypto_hex2rgba( $highlight_post_category_color, 0.5 ) ).';
    	}
	...
	$highlight_posts_radius = get_theme_mod( 'bosa_crypto_highlight_posts_radius', 0 );
	$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_footer_layout', 'footer_one' ) == 'footer_one' || get_theme_mod( 'bosa_crypto_footer_layout', 'footer_one' ) == 'footer_two' ){
		$bottom_footer_image_width = get_theme_mod( 'bosa_crypto_bottom_footer_image_width', 270 );
		$css .= '
	...
	if( get_theme_mod( 'bosa_crypto_disable_responsive_footer_widget', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.top-footer {
	    			display: none;
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_scroll_top', true ) ){
		$css .= '
			@media screen and (max-width: 767px){
				#back-to-top {
	...
	# Sidebar Border
	if( get_theme_mod( 'bosa_crypto_disable_sidebar_widget_title_border', false ) ){
		$css .= '
	...
	# Theme Skins
	# Dark Skin
	if( get_theme_mod( 'bosa_crypto_skin_select', 'default' ) == 'dark' ){
		$css .= '
			body,
	...
	# Black and White
	elseif( get_theme_mod( 'bosa_crypto_skin_select', 'default' ) == 'blackwhite' ){
		$css .= '
	...
	$product_card_style 		= get_theme_mod( 'bosa_crypto_woocommerce_product_card_style', 'card_style_one' );
	// Product image and card radius
	$shop_product_image_radius 	= get_theme_mod( 'bosa_crypto_shop_product_image_radius', 0 );
	$shop_product_card_radius 	= get_theme_mod( 'bosa_crypto_shop_product_card_radius', 0 );
	...
	// Add to cart Colors
	$add_to_cart_button 	= get_theme_mod( 'bosa_crypto_woocommerce_add_to_cart_button', 'cart_button_two' );
	$add_to_cart_bg_color 	= get_theme_mod( 'bosa_crypto_add_to_cart_bg_color', '#333333' );
	$add_to_cart_text_color = get_theme_mod( 'bosa_crypto_add_to_cart_text_color', '#ffffff' );
	
	if( $add_to_cart_button == 'cart_button_three' ){
		$add_to_cart_text_color = get_theme_mod( 'bosa_crypto_add_to_cart_black_text_color', '#333333' );
	}elseif( $add_to_cart_button == 'cart_button_four' ){
		$add_to_cart_bg_color 	= get_theme_mod( 'bosa_crypto_add_to_cart_white_bg_color', '#ffffff' );
		$add_to_cart_text_color = get_theme_mod( 'bosa_crypto_cart_four_black_text_color', '#333333' );
	}
	$css .= '
	...
	$add_cart_button_radius = get_theme_mod( 'bosa_crypto_add_cart_button_radius', 0 );
	$css .= '
		.woocommerce .button-cart_button_four > a.button {
	...
	$cart_four_diagonal_spacing = get_theme_mod( 'bosa_crypto_cart_four_diagonal_spacing', 10 );
	$css .= '
	...
	// Sale Tag Layout
	$sale_tag_layout = get_theme_mod( 'bosa_crypto_woocommerce_sale_tag_layout', 'sale_tag_layout_one' );
	// Sale Button diagonal spacing
	$sale_button_diagonal_spacing = get_theme_mod( 'bosa_crypto_sale_button_diagonal_spacing', 8 );
	
	$icon_group_layout 				= get_theme_mod( 'bosa_crypto_icon_group_layout', 'group_layout_one' );
	...
	// Sale Tag Colors
	$sale_tag_bg_color = get_theme_mod( 'bosa_crypto_sale_tag_bg_color', '#00D094' );
	$sale_tag_text_color = get_theme_mod( 'bosa_crypto_sale_tag_text_color', '#ffffff' );
	$css .= '
	...
	$sale_button_border_radius = get_theme_mod( 'bosa_crypto_sale_button_border_radius', 0 );
	$css .= '
		.woocommerce ul.products li.product span.onsale {
	...
	// Single Products
	$disable_single_product_sku = get_theme_mod( 'bosa_crypto_disable_single_product_sku', false );
	$disable_single_product_category = get_theme_mod( 'bosa_crypto_disable_single_product_category', false );
	$disable_single_product_tags = get_theme_mod( 'bosa_crypto_disable_single_product_tags', false );
    ...
    // Icon Group layout
    $icon_group_layout 				= get_theme_mod( 'bosa_crypto_icon_group_layout', 'group_layout_one' );
    $icon_group_one_border_radius 	= get_theme_mod( 'bosa_crypto_icon_group_one_border_radius', 100 );
    $icon_group_two_border_radius 	= get_theme_mod( 'bosa_crypto_icon_group_two_border_radius', 0 );
    $icon_group_three_border_radius = get_theme_mod( 'bosa_crypto_icon_group_three_border_radius', 0 );
    $icon_group_four_border_radius 	= get_theme_mod( 'bosa_crypto_icon_group_four_border_radius', 100 );

    // Icon group layout  diagonal spacing
	$icon_group_diagonal_spacing = get_theme_mod( 'bosa_crypto_icon_group_diagonal_spacing', 10 );
	...
	/* Icon group colors */
	$icon_group_bg_color 	= get_theme_mod( 'bosa_crypto_icon_group_bg_color', '#ffffff' );
	$icon_group_text_color  = get_theme_mod( 'bosa_crypto_icon_group_text_color', '#383838' );
	$css .= '
		body[class*=woocommerce] ul.products li .product-compare-wishlist a i,
		body[class*=woocommerce] ul.products li .product-compare-wishlist .add_to_wishlist:has(svg),
		body[class*=woocommerce] ul.products li .product-wishlist .yith-wcwl-add-to-wishlist-button:has(svg) {
	...
	$woocommerce_product_card_text_alignment 	= get_theme_mod( 'bosa_crypto_woocommerce_product_card_text_alignment', 'text-center' );
	...
	# Responsive Popular Crypto section
	if( get_theme_mod('bosa_crypto_disable_mobile_popular_cryptos', false ) ){
		$css .='
			@media screen and (max-width: 767px){
				.section-crypto-area {
	    			display: none;
	...
	if( get_theme_mod( 'bosa_crypto_disable_mobile_testimonials', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	# Responsive Crypto Info section
	if( get_theme_mod( 'bosa_crypto_disable_mobile_crypto_info', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.section-crypto-info-area {
	    			display: none;
				}
			}
		';
	...
	$css .= '</style>';
	?>
	<?php if( get_theme_mod( 'bosa_crypto_site_layout', 'default' ) == 'box' || get_theme_mod( 'bosa_crypto_site_layout', 'default' ) == 'frame' ){ ?>
		<style type="text/css">
		    .site-layout-frame,
		    .site-layout-box { background-image: url('<?php echo esc_url( wp_get_attachment_url( get_theme_mod( 'bosa_crypto_box_frame_background_image', '' ) ) ); ?>'); }
		</style>
	<?php } ?>
	<?php
...
add_action( 'wp_head', 'bosa_crypto_default_styles' );