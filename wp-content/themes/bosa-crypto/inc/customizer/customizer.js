...
( function( $ ) {
	...
	wp.customize( 'bosa_crypto_logo_width', function( value ) {
		value.bind( function( to ) {
			$( '.site-header .site-branding > a' ).css( "max-width", to + 'px' );
		} );
	} );

	wp.customize( 'bosa_crypto_fixed_header_logo_width', function( value ) {
		value.bind( function( to ) {
	...
	// Header text color.
	wp.customize( 'bosa_crypto_header_textcolor', function( value ) {
		value.bind( function( to ) {
			if ( 'blank' === to ) {
	...
	wp.customize( 'bosa_crypto_preloader_custom_image_width', function( value ) {
		value.bind( function( to ) {
	...
	// Header image height
	wp.customize( 'bosa_crypto_header_image_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_social_icons_size', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_main_slider_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_feature_posts_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_bottom_footer_image_width', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_feature_posts_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_highlight_posts_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_transparent_header_banner_post_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_transparent_header_banner_page_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_latest_posts_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_sale_button_border_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_icon_group_one_border_radius', function( value ) {
	    value.bind( function( to ) {
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist a i' ).css( "borderRadius", to + 'px' );
	    } );
	} );

	wp.customize( 'bosa_crypto_icon_group_two_border_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_icon_group_three_border_radius', function( value ) {
	    value.bind( function( to ) {
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist > div:first-child a i' ).css( "border-top-left-radius", to + 'px' );
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist > div:first-child a i' ).css( "border-bottom-left-radius", to + 'px' );
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist > div:last-child a i' ).css( "border-top-right-radius", to + 'px' );
	...
	wp.customize( 'bosa_crypto_icon_group_four_border_radius', function( value ) {
	    value.bind( function( to ) {
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist a i' ).css( "borderRadius", to + 'px' );
	    } );
	} );
	...
	wp.customize( 'bosa_crypto_shop_product_image_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_shop_product_card_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_add_cart_button_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_cart_four_diagonal_spacing', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_icon_group_diagonal_spacing', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_sale_button_diagonal_spacing', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_crypto_woocommerce_product_card_text_alignment', function( value ) {
	    value.bind( function( to ) {
